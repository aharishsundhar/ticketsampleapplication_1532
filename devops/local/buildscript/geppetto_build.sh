...
APPLICATION='/ticketsampleapplication'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication-desktop:1.0'
...
helm install --name ticketsampleapplication-1532 ./helm
if [ $? -eq 0 ]; then
